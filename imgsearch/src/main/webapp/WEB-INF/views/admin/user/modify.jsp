				...
				<div class="widget-body" style="padding: 10px 0 0;">
								...
								<tr>
									...
									<td width="40%">
										<div>
											...
											<form align="right" id="userForm" action="modify" method="post">
												
												<c:choose>
													<c:when test="${empty vo.ug_rumor  }">
														<p>
															연령: <input type="number" id="ug_age" name="ug_age"
														...
														<p>
															친근함: <input type="number" id="ug_kind" name="ug_kind"
																min="1" max="9" step="1" value="1"
																onchange="valueChange(this)">
														</p>
														<p>
															지적성향: <input type="number" id="ug_intell"
																name="ug_intell" min="1" max="9" step="1" value="1"
																onchange="valueChange(this)">
														</p>
														<p>
														...
														<p>
															사건사고: <input type="number" id="ug_trouble"
																name="ug_trouble" min="1" max="9" step="1" value="1"
																onchange="valueChange(this)">
														</p>
														<p>
															루머: <input type="number" id="ug_rumor" name="ug_rumor"
																min="1" max="9" step="1" value="1"
																onchange="valueChange(this)">
														</p>
													...
													<c:otherwise>
														<p>
															연령: <input type="number" id="ug_age" name="ug_age"
																min="1" max="9" step="1" value="${vo.ug_age }"
																onchange="valueChange(this)">
														</p>
														<p>
															외모: <input type="number" id="ug_view" name="ug_view"
																min="1" max="9" step="1" value="${vo.ug_view }"
																onchange="valueChange(this)">
														</p>
														<p>
															친근함: <input type="number" id="ug_kind" name="ug_kind"
																min="1" max="9" step="1" value="${vo.ug_kind }"
																onchange="valueChange(this)">
														</p>
														<p>
															지적성향: <input type="number" id="ug_intell"
																name="ug_intell" min="1" max="9" step="1" value="${vo.ug_intell }"
																onchange="valueChange(this)">
														</p>
														<p>
															얼굴: <input type="number" id="ug_face" name="ug_face"
																min="1" max="9" step="1" value="${vo.ug_face }"
																onchange="valueChange(this)">
														</p>
														<p>
															사건사고: <input type="number" id="ug_trouble"
																name="ug_trouble" min="1" max="9" step="1" value="${vo.ug_trouble }"
																onchange="valueChange(this)">
														</p>
														<p>
															루머: <input type="number" id="ug_rumor" name="ug_rumor"
																min="1" max="9" step="1" value="${vo.ug_rumor }"
																onchange="valueChange(this)">
														</p>
													</c:otherwise>
													</c:choose>
					...
					<div class="widget-body" style="padding: 10px 0 0;">
						<table class="table table-bordered table-primary">
							...
							<input name="u_id" type="hidden" value="${vo.u_id}">
							<input name="u_no" type="hidden" value="${vo.u_no}">
							
							<tbody>
								<tr>
								
									<td><p class="span2" style="border: 0"READONLY">${vo.u_id }</p></td>
									<td><input type="text" name="u_pw"
										value="${vo.u_pw}" class="span2" style="border: 0"READONLY"></td>
									<td><input type="email" name="u_email"
										value="${vo.u_email}" class="span2" style="border: 0"READONLY"></td>
								</tr>
							</tbody>
						</table>
					</div>
					...
					<div class="row-fluid">
						<div class="span2">
							<button onclick="modiUser()" class="btn btn-block btn-primary">등록</button>
						</div>
						<div class="span2">
							<button onclick="location.href='view?u_no=${vo.u_no}'"
